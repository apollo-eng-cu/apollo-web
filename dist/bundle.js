...
/***/ function(module, exports, __webpack_require__) {
	...
	var Logo = function Logo() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'a',
	      { className: 'nav-item', href: '#header', 'data-scroll': true },
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "p",
	            null,
	            "จะเรียนจบแล้ว จะฝึกงานแล้ว จะเลือกภาคแล้ว พร้อมกันยัง ? รู้หรือยังว่าอยากเลือกเดินทางไหน ต้องเตรียมตัวยังไงบ้าง ?"
	          )
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = function (_Component) {
	  ...
	  function Register() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Register)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = { data: { firstName: '',
	        lastName: '',
	        email: '',
	        telNum: '',
	        year: '',
	      ...
	      sid: { pattern: /^\d{8}21$/,
	        msg: 'ต้องใส่รหัสนิสิตเป็นเลข 8 หลัก ตามด้วยรหัสคณะ(21)'
	      }
	      ...
	      if (status === 'requesting') {
	        (function () {
	          ...
	          xhr.onreadystatechange = function () {
	            if (xhr.readyState == 4 && xhr.status == 200 && /Submit another response/.test(xhr.responseText)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "asset/img/bg-banner.8ad25ee465bf7eb26d434b4411fd2e71.png";
